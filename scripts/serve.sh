...
# for a text-only flow. 1.02 GB of memory nothing here uses, and on a machine with no desk
# to protect that is context: the node config sets it, the desk configs leave it alone.
